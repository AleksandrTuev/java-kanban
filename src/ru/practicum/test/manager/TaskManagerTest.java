...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    private void creatingTasks(){
        //id=1
        Task task1 = new Task("Task 1", "Description 1/Task 1");
        int taskId1 = taskManager.addNewTask(task1);
        //id=2
        Task task2 = new Task("Task 2", "Description 2/Task 2");
        int taskId2 = taskManager.addNewTask(task2);

        //id=3
        Epic epic1 = new Epic("Epic 1", "Description 1/Epic 1");
        ...
        //id=7
        Epic epic2 = new Epic("Epic 2", "Description 2/Epic 2");
