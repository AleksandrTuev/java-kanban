...
class FileBackedTaskManagerTest extends TaskManagerTest<FileBackedTaskManager>{
    ...
    Assertions.assertEquals("Description 1/Task 1",restoredFromFile.getTaskToId(1).getDescription());
    Assertions.assertEquals("Description 1/Epic 1",restoredFromFile.getEpicToId(3).getDescription());
